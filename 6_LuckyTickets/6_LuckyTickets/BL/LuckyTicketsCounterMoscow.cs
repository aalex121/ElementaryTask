...
{
    public class LuckyTicketsCounterMoscow : LuckyTicketsCounter
    {
        #region Constants
        private const int MIN_POSSIBLE_DIGITS_COUNT = 2;
        private const int MAX_RECURSION_DEPTH = 7100;
        #endregion

        public LuckyTicketsCounterMoscow()
        ...
        {
            if (digits < MIN_POSSIBLE_DIGITS_COUNT)
            {
                return 0;
            }
