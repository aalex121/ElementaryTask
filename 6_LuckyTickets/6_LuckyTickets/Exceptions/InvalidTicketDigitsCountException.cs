...
{
    public class InvalidTicketDigitsCountException : ArgumentException
    {
        #region Constants
        private const string ERROR_MESSAGE = "Ticket digit quantity must be positive and even!";
        private const string INVALID_PARAM_MESSAGE = "Provided digit quantity is";
        #endregion
